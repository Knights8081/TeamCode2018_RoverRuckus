...
/**
 * Created by lfrazer on 1/13/18.
 */

@Autonomous(name="Vuforia auto drive BLUE SIDE", group="PushBot")
@Disabled
public class PushbotAutoDriveByEncoder_Linear_SideBlue extends LinearOpMode {
...
//                robot.getLeftClaw().setPosition(.9);            // S4: Stop and close the claw.
                ...
                sleep(1000);
                encoderDrive(RobotConstants.DRIVE_SPEED,  35.5,  35.5, 5.0);  // S1: Forward 48 Inches with 5 Sec timeout
...
//                robot.getLeftClaw().setPosition(.9);            // S4: Stop and close the claw.
                ...
                robot.getRightClaw().setPosition(-.9);
                sleep(1000);
                encoderDrive(RobotConstants.DRIVE_SPEED,  28,  28, 5.0);  // S1: Forward 48 Inches with 5 Sec timeout
                robot.getClawLift().setPower(.5);
                sleep(300);
                robot.getClawLift().setPower(0.0);
                encoderDrive(RobotConstants.TURN_SPEED,   -29, 29, 4.0);  // S2: Turn Right 12 Inches with 4 Sec timeout
