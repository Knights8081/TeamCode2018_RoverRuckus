...
@Autonomous(name="Vuforia auto drive RED MID", group="PushBot")
@Disabled
public class PushbotAutoDriveByEncoder_Linear_MidRED extends LinearOpMode {
...
//                robot.getLeftClaw().setPosition(.9);            // S4: Stop and close the claw.
                ...
                encoderDrive(RobotConstants.DRIVE_SPEED, -9, -9, 4.0);  // S3: Reverse 12 Inches with 4 Sec timeout
...
//                robot.getLeftClaw().setPosition(.9);            // S4: Stop and close the claw.
                ...
                robot.getClawLift().setPower(0.0);
                encoderDrive(RobotConstants.TURN_SPEED,   22, -22, 4.0);  // S2: Turn Right 12 Inches with 4 Sec timeout
                encoderDrive(RobotConstants.DRIVE_SPEED, -2, -2, 4.0);  // S3: Reverse 12 Inches with 4 Sec timeout
